...
namespace MagicVilla_VillaAPI.Migrations
{
    ...
    [Migration("20250428191935_UpdateTables")]
            ...
            modelBuilder.Entity("MagicVilla_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2025, 4, 28, 21, 19, 35, 166, DateTimeKind.Local).AddTicks(5435),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2025, 4, 28, 21, 19, 35, 169, DateTimeKind.Local).AddTicks(6920),
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2025, 4, 28, 21, 19, 35, 169, DateTimeKind.Local).AddTicks(6937),
                            Details = "Sed ut perspiciatis, quia voluptas sit, aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos, qui ratione voluptatem sequi nesciunt, neque porro quisquam est, sunt in culpa qui officia deserunt mollit anim id est laborum!",
                            ImageUrl = "",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2025, 4, 28, 21, 19, 35, 169, DateTimeKind.Local).AddTicks(6940),
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2025, 4, 28, 21, 19, 35, 169, DateTimeKind.Local).AddTicks(6943),
